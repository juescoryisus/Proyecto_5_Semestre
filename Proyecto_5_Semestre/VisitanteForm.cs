...
{
    public partial class VisitanteForm : Form
    {
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            // Consulta SQL para insertar los datos en la tabla Visitante
            string query = "INSERT INTO Visitante (nombre, apellidoPaterno, apellidoMaterno, numero, telefono, idRecursosHumanos, status) " +
                           "VALUES (@nombre, @apellidoPaterno, @apellidoMaterno, @numero, @telefono, @idRecursosHumanos, @status)";
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Visitantes guardados correctamente.");
        }
